...
class RegistrarRecorridoPage extends StatefulWidget {
  ...
  const RegistrarRecorridoPage({super.key, required this.user});

  @override
  _RegistrarRecorridoPageState createState() => _RegistrarRecorridoPageState();
}

class _RegistrarRecorridoPageState extends State<RegistrarRecorridoPage> {
  ...
  final List<String> _tiposRecorrido = [
    'Entrada',
    'Salida',
    'Cancelada - Pagada',
    'Maletas'
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      appBar: AppBar(
        ...
        title: const Text('Registro de Recorrido',
        ...
        child: Form(
          ...
          child: Column(
            children: [
              ...
              if (_otraHora) _buildManualHourInput(),
              const SizedBox(height: 20),
  ...
  Widget _buildTipoRecorrido() {
    return Wrap(
      spacing: 10,
      children: _tiposRecorrido.map((tipo) {
